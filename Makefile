LANGUAGE_NAME := tree-sitter-enforce
HOMEPAGE_URL := https://github.com/simonvic/tree-sitter-enforce
VERSION := 0.4.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/enforce '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/enforce
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/enforce
